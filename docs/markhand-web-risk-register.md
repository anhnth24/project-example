...
| R-P0-10-MIG-01 | High | Model/index cutover from interim GLM/local CPU evidence to on-prem vLLM may require full rebuild and rollback storage. | retrieval-owner, operations-owner | Block production embedding cutover until expand/cutover/contract runbook is tested. | ADR 0006, ADR 0011. |
