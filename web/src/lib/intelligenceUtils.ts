// Ported as-is from app/src/lib/intelligenceUtils.ts (desktop). Pure
// functions only, no Tauri/filesystem dependency, so it copies over
// unmodified for reuse by the future web Q&A/library scope UI (P2-04/P2-10).
...
export function reconcileIntelligenceScope(current: string[], available: string[]): string[] {
