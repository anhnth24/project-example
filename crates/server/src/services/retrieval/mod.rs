...
pub struct RetrievalHit {
    ...
    /// Original source object SHA-256.
    pub content_sha256: String,
    /// Canonical Markdown artifact SHA-256 (empty when unknown).
    ...
    hybrid_hits
        ...
        .filter_map(|hit| {
            ...
            Some(RetrievalHit {
                ...
                canonical_markdown_sha256: chunk.canonical_markdown_sha256.clone(),
...
mod tests {
    ...
    fn authorized(
        ...
        AuthorizedChunk {
            ...
            document_title: "Đối soát tài liệu".into(),
    ...
    fn as_of_visibility_uses_resolved_version_set() {
        ...
        let mut row = crate::db::search::HydratedChunkRow {
            ...
            canonical_markdown_sha256: "e".repeat(64),
            document_title: "Sample Document".into(),
    ...
    fn deleted_tombstoned_suppressed_in_authorize() {
        ...
        let mut row = crate::db::search::HydratedChunkRow {
            ...
            canonical_markdown_sha256: "e".repeat(64),
            document_title: "Secret Document".into(),
            heading_path: vec![],
            body: "secret".into(),
            page: None,
            slide: None,
