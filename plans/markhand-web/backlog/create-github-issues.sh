...
create_if_missing "F-01 \u2014 Architecture boundaries v\u00e0 dependency rules" \
  ...
  --milestone "Phase F \u2014 Engineering foundation" \
  --label "markhand-web,docs,web-foundation,ready"
...
create_if_missing "F-02 \u2014 Workspace v\u00e0 folder skeleton" \
  ...
  --milestone "Phase F \u2014 Engineering foundation" \
  --label "markhand-web,docs,web-foundation,blocked"
...
create_if_missing "P0-05 \u2014 \u0110\u00e1nh gi\u00e1 embedding ti\u1ebfng Vi\u1ec7t" \
  ...
  --body "## Metadata\n\n- Milestone: Phase 0 \u2014 Discovery & Gates\n- Phase code: 0\n- Issue ID: P0-05\n- Status: `blocked`\n- Catalog: `backlog/phase-0/issues/README.md`\n- Phase plan: `phase-0-discovery-and-gates.md`\n\n## Objective\n\nCh\u1ecdn model/revision/dimension/normalization theo quality + capacity.\n\n## Implementation plan\n\nSo `bge-m3` v\u00e0 multilingual-e5; pin tokenizer/batch/truncation; \u0111o theo\ncategory, queue depth, cold/warm.\n\n## Files/modules\n\n`bench/markhand_web/embedding/`, `scripts/run_embedding_eval.py`,\n`reports/embedding-evaluation.md`, ADR model.\n\n## Dependencies / blocks\n\nCorpus, spike, GPU, approved model download.\n\n## Acceptance criteria\n\n\u22652 model family c\u00f9ng corpus/hardware; model ch\u1ecdn \u0111\u1ea1t gate v\u00e0 kh\u00f4ng\nk\u00e9m best v\u01b0\u1ee3t margin \u0111\u00e3 duy\u1ec7t; config immutable trong report.\n\n## Required tests / evidence\n\nRecall/MRR/nDCG, P50/P95/P99, vectors/s, VRAM, saturation,\nfailure rate; \u22653 runs.\n\n## Security and migration notes\n\nRestricted corpus kh\u00f4ng ra cloud; license tr\u01b0\u1edbc bundle.\n\n## Out of scope\n\nAutoscaling v\u00e0 \u0111\u1ed5i desktop embedding.\n\n## Source\n\nGenerated from Markhand Web backlog catalog. Update the catalog first, then re-run `python3 scripts/sync-github-issues.py --update` if specs change.\n" \
  --milestone "Phase 0 \u2014 Discovery & Gates" \
  --label "markhand-web,docs,web-p0,blocked"
...
create_if_missing "P1A-01 \u2014 Freeze desktop RAG v\u00e0 IPC contracts" \
  ...
  --milestone "Phase 1A \u2014 Knowledge Extraction" \
  --label "markhand-web,docs,web-p1a,blocked"
