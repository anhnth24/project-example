...
-- Allowed: auth/org/role/collection fixtures only.
-- Forbidden: documents / document_versions / jobs / chunks / object-store rows.
...
-- Second org for IDOR matrix (identity only — documents created via public API).
